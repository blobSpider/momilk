...
public interface FeedingRecordDao extends GenericDao<FeedingRecord, Long>{
	...
	public final String columnUnit = "measureUnit";
	public final String columnValue = "measureValue";
	public final String columnUpdatedTime = "updatedTime";
	public final Object [] columns = {columnId, columnSessionId, columnType, columnUnit, columnValue, columnUpdatedTime};

	public final String tableCreateQuery = String.format("CREATE TABLE IF NOT EXISTS %s ( %s INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, %s LONG, %s TEXT, %s TEXT, %s LONG, %s LONG);", table, columnId, columnSessionId, columnType, columnUnit, columnValue, columnUpdatedTime);
